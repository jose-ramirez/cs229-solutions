...
log_phi_k1 = log(phi_k1);
log_phi_k0 = log(phi_k0);

log_test_spam = (log_phi_k1 * testMatrix') + log(phi_y);
log_test_ham = (log_phi_k0 * testMatrix') + log(1 - phi_y);

output = (log_test_spam > log_test_ham)';
%---------------
